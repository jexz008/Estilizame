...
try {
    ...
    $estado         = $_POST['evento_estado_nombre'];
    ...
    $Evento = new Evento();
    $Empresa = new Empresa();
    $eventoId = $Evento->setEvento($nombre, $descripcion, $fechaInicio, $horaInicio, $fechaFin, $horaFin, $estado, $municipio, $direccion, NULL, $tipoEventoId, $empresaId, $usuarioId);
