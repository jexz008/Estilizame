...
HTML;
                ...
                <ul class="nav navbar-nav navbar-right">
                  <!--<li><a href="/"><i class="glyphicon glyphicon-user"></i> <?= $_SESSION['xc_usuario_nombre'] ?></a></li>-->
                    ...
                    <?php }else{ ?>
                    <li><a href="index.php?module=perfil&perfil=<?=$_SESSION[$_app->prefijo.'_usuario_empresa_id']?>"><i class="glyphicon glyphicon-user"></i> <?= mb_strimwidth($_SESSION[$_app->prefijo.'_usuario_empresa'], 0, 40, '...') ?></a></li>
