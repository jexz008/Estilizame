<head>
    <meta charset="utf-8">
    <title><?= $_Modulo . " - " . $_app->nombre ?></title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge, chrome=1" />

    <meta name="viewport" content="width=device-width, maximum-scale=1.0">
    <meta name="Description" content="<?= $_app->site_desc ?>" />
    <meta name="Keywords" content="<?= $_app->site_keyworks ?>" />
    ...
    <script src="libs/bootstrap/js/bootstrap.min.js?version<?= $_app->version ?>"></script>
